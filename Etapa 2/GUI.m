...
function [entrada metodo]= btnResolver(editText, gp)
  ...
  if (entrada(1) <=0 |entrada(2) <=0|entrada(3) <=0|entrada(4) <=0|entrada(5) <=0 |entrada(6) <=0)
...
#gp2 =  uibuttongroup(5gpp, "Position", [0.05, 0.01, 0.89 0.55], "title", "Salida","backgroundcolor","white");
